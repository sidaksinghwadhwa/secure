...
{ 
   ...
   else if( document.myForm.Address1.value.length<10 ||document.myForm.Address1.value.length>100 || document.myForm.Address1.value=="" )
   {
   ...
   else if(document.myForm.ContactNumber.value.length<10|| document.myForm.ContactNumber.value.length>20 || /^([0-9]+||^$)$/.test(document.myForm.ContactNumber.value)!=true )
   {
...
<form:form method="GET" action="save" name="myForm" onsubmit="return validate();">
   <table>
    <tr>
     <form:errors path="*" cssStyle="color : red;"/>
        <td>Customer Code :</td>
        <td><form:label path="CustomerCode"></form:label><form:errors path="CustomerCode" /></td>
